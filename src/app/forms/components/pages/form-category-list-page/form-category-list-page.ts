...
export class FormCategoryListPage implements OnInit {
  ...
  readonly gruposProcesos = [
    ...
    },
    {
      ...
      items: [
        { code: 'OPERACION_LOGISTICA', label: 'Operación Logística del Servicio Farmacéutico', descripcion: 'Logística de servicio', imagen: 'categories/comercial.png', bgColor: '#E8F5E9', textColor: '#1B5E20' },
        { code: 'PREPARADOS_ESTERILES', label: 'Elaboración y Adecuación de preparados Estériles y no Estériles', descripcion: 'Elaboración de preparados', imagen: 'categories/calidad.png', bgColor: '#FCE4EC', textColor: '#880E4F' },
        { code: 'DISTRIBUCION_MEDICAMENTOS', label: 'Distribución de Medicamentos, Dispositivos Médicos e Insumos', descripcion: 'Distribución y medicamentos', imagen: 'categories/comercial.png', bgColor: '#E0F7FA', textColor: '#006064' }
      ]
    },
    {
